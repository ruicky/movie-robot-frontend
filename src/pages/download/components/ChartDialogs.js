...
function MovieTypeChart({ data }) {
  ...
  return <ReactECharts option={movieCountOption} />;
}
...
function SiteChart({ data }) {
  ...
  return <ReactECharts option={siteOption} />;
}
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          {movieCountData ? (
            <MovieTypeChart data={movieCountData} />
          ) : (
            <Skeleton variant="rectangular" />
          )}
          {siteCountData ? <SiteChart data={siteCountData} /> : <Skeleton variant="rectangular" />}
        </DialogContent>
        <DialogActions>
