...
function SearchRecords(props) {
  ...
  return (<React.Fragment>
      ...
      {param?.keyword && param?.searchDouban && param?.searchDouban === "true" &&
        <FilterOptionsProvider><SubscribeList keyword={param?.keyword}
                                              posterWall={Boolean(appInfo?.server_config?.douban_poster_wall)} /></FilterOptionsProvider>}
      {pageIsLoading && <Box
        sx={{
      ...
      <ImageCarouselDialog open={imageCarousel.open}
