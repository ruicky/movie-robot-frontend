...
function SelectDialog({open, handleClose, configured = []}) {
    ...
    return (
        <Dialog onClose={handleClose} open={open}>
            ...
            <List sx={{pt: 0}}>
                <ListItem disabled={configured.includes("qywx")} button onClick={() => navigate("/setting/edit-notify?type=qywx")}>
                    <ListItemIcon>
                ...
                <ListItem disabled={configured.includes("bark")} button onClick={() => navigate("/setting/edit-notify?type=bark")}>
                    <ListItemIcon>
                ...
                <ListItem disabled={configured.includes("pushdeer")} button onClick={() => navigate("/setting/edit-notify?type=pushdeer")}>
                    <ListItemIcon>
