...
function License() {
  ...
  useEffect(() => {
    ...
    if (licenseType === "FAMILY_VIP") {
      setLicenseMessage("您已经是最高等级用户，尊贵的家庭永久授权！❤️🎉🌹");
      setIsVip(true);
    } else if (licenseType === "VIP") {
      setLicenseMessage("您已经是最高等级用户，尊贵的个人永久授权！❤️🎉🌹");
      setIsVip(true);
          ...
          <Grid container spacing={6} alignItems="flex-end">
            <Grid item xs={12} md={4}>
              <LicenseItem
                ...
                不支持豆瓣、微信应用通道订阅<br />
                <Link target={"_blank"}
                      href={"http://moviebot.fun/register"}>注册体验</Link>
                <br /><br />
              </LicenseItem>
            </Grid>
            {/*<Grid item xs={12} md={4}>*/}
            ...
            <Grid item xs={12} md={4}>
              <LicenseItem
                showPrice={licenseType !== "VIP" && licenseType !== "FAMILY_VIP"}
                title={"永久授权"}
                selected={licenseType === "VIP" || licenseType === "FAMILY_VIP"}
                price={(licenseType === "VIP" || licenseType === "FAMILY_VIP") ? "已购买" : "¥299"}
                period={(licenseType === "VIP" || licenseType === "FAMILY_VIP") ? "" : "/永久"}
                actionsComponent={(licenseType === "VIP" || licenseType === "FAMILY_VIP") ? (
                  <Button fullWidth variant="contained" color="primary"
                          onClick={() => window.open("https://discord.gg/SMauZCXgKx")}>
                    去产品社区
                  </Button>
                  ...
                  <Button
                    ...
                    variant="outlined"
                    color="primary"
                    onClick={() => window.open("http://moviebot.fun/#pricing")}
                  >
                    {licenseType === "SubVIP" || licenseType === "ExperienceUser" ? "升级" : "购买"}
                  </Button>
                )}
              >
                无限制使用自建中文影视数据库<br />
