...
export const registerUser = async (username, password, nickname, role, douban_user, qywx_user, pushdeer_key, bark_url, score_rule_name, permission_category, telegram_user_id, approval_enable) => {
...
export const updateUser = async (uid, username, nickname, new_password, role, douban_user, qywx_user, pushdeer_key, bark_url, score_rule_name, permission_category, telegram_user_id, approval_enable) => {
    const result = await axios.post("/api/user/update_user", {
        ...
        score_rule_name,
        permission_category,
        telegram_user_id, approval_enable
    })
    return result;
}
